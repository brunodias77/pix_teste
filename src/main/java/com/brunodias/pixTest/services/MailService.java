...
public class MailService
{
    ...
    private String verifyUrl = "http://localhost:8088/user/verify?code=";

    public void sendVerificationEmail(User user) throws MessagingException {
        String toAddres = user.getEmail();
        String fromAddres = "usuariofollow583@gmail.com";
        String senderName = "usuariofollow";
